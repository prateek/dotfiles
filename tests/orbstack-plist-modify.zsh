...
source_json="$DOTFILES_ROOT/home/.chezmoiassets/Library/Preferences/dev.kdrag0n.MacVirt.json"
...
chezmoi \
  ...
  execute-template \
  --file "$DOTFILES_ROOT/home/Library/Preferences/modify_private_dev.kdrag0n.MacVirt.plist.tmpl" \
  >"$script"
chmod +x "$script"
