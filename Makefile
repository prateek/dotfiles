...
## Regression tests for raw session sync followed by the derived QMD refresh.
test-wiki-sessions-sync:
	@$(MAKE) --no-print-directory test-shell BATS_PATH=tests/bats/agents/wiki-sessions-sync.bats
