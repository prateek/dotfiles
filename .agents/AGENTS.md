# ABOUTME: Shared agent instructions — behavioral rules, coding standards, and convention references.
# ABOUTME: Read by all coding agents (Codex, Claude Code, OpenCode) via symlinks.
