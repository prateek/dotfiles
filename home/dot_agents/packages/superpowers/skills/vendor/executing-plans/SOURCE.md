...
- Notes: Vendored from the upstream marketplace plugin (repo-root dependency). Local delta: LICENSE.txt copies the repository-level MIT notice into this skill root.
