...
| Dimension | Question |
| --- | --- |
| Directness | Does the prose make statements instead of announcing them? |
| Specificity | Can the reader see the actor, object, evidence, or consequence? |
| Rhythm | Do sentence and paragraph lengths vary naturally? |
| Voice fit | Does it match the genre, audience, and any sample? |
| Density | Is anything still cuttable without losing meaning? |

Revise if the total is below 38 out of 50, or if any dimension is below 7 for public-facing prose.
