...
Full rationale lives in `docs/adr/0001-downstream-fork-architecture.md` relative to the dotfiles repo root. The historical plan doc is `docs/plans/setup-downstream-fork-plan.md`. This file is the operational summary.
