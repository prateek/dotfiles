...
Full rationale lives in `~/dotfiles/dev/adr/0001-downstream-fork-architecture.md`. The plan doc at `~/dotfiles/dev/docs/setup-downstream-fork-plan.md` carries the workflow recipes. This file is the operational summary.
