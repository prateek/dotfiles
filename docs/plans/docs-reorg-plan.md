...
Keep the lifecycle validator as one self-contained executable Python file under
`docs/`, for example `docs/validate-doc-lifecycle.py`. `tests/docs-lifecycle.zsh`
...
Update `home/dot_agents/packages/core/skills/local/code-gardening/SKILL.md` with docs routing,
...
3. **Remove non-canonical `skill_path:`** from the two
   ...
   `current_guidance: [../../home/dot_agents/packages/review/skills/local/setup-downstream-fork/]`.
...
8. **Update skill cross-references**:
   ...
   - `home/dot_agents/packages/core/skills/local/code-gardening/SKILL.md`: add the folder-purposes
     pointer paragraph.
   - `home/dot_agents/packages/review/skills/local/setup-downstream-fork/SKILL.md`: update
     `docs/plans/setup-downstream-fork-plan.md` -> `docs/plans/`.
   - `home/dot_agents/packages/review/skills/local/setup-downstream-fork/references/architecture.md`:
     replace absolute `~/dotfiles/docs/...` paths with repo-relative paths and
     update `dev/` -> `plans/`.
   - `.agents/skills/chezmoi-management/` and
     `home/dot_agents/packages/core/skills/local/chezmoi-management/`: update links to
...
2. **Validator filename.** Choose the exact self-contained validator path under
   `docs/`, for example `docs/validate-doc-lifecycle.py`.
