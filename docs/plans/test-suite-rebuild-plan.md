...
| [land-changes](../../agent-marketplace/packages/review/skills/land-changes/SKILL.md) | Make Validation Gates read the tests index for changed-area checks, with Make/CI as executable truth. Preserve the existing landing procedure. |
