...
If `/Users/prateek/.codex/skills/ui-ux-pro-max/SKILL.md` exists, use that as the broader design review source. This file is the portable subset for repo-driven guideline sites, so the skill still works when that local skill is missing.
