...
If the local skill exists at `/Users/prateek/.codex/skills/ui-ux-pro-max/SKILL.md`, use it as the primary review rubric. For this skill, only apply the relevant parts for guideline sites:
